...
func TestAndroid(t *testing.T) {
	...
	workspace, err := ioutil.TempDir("", "gmc-android-")
	if err != nil {
	...
	for _, dir := range []string{"src/main", "src/androidTest/java/org/musicoin/gmctest", "libs"} {
	...
	build.CopyFile(filepath.Join("libs", "gmc.aar"), "gmc.aar", os.ModePerm)

	if err = ioutil.WriteFile(filepath.Join("src", "androidTest", "java", "org", "musicoin", "gmctest", "AndroidTest.java"), []byte(androidTestClass), os.ModePerm); err != nil {
