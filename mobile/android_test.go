...
func TestAndroid(t *testing.T) {
	...
	for _, dir := range []string{"src/main", "src/androidTest/java/org/ethereum/gmctest", "libs"} {
	...
	if err = ioutil.WriteFile(filepath.Join("src", "androidTest", "java", "org", "ethereum", "gmctest", "AndroidTest.java"), []byte(androidTestClass), os.ModePerm); err != nil {
